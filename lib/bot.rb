  ...
  def initialize
    ...
    Telegram::Bot::Client.run(token) do |bot|
      bot.listen do |message|
        ...
        when "/learn"
          new_word = %w[salut/hello bonsoir/good,evening comment,tu,vas/how,are,you? je,vais,bien/i,am,fine tu,me,manque/i,miss,you]
        ...
        when "/movies"
          new_movies = %w[jurassic,world avengers the,lion,king tigertail the,assistant hamilton shirley star,is,born the,gentleman]
